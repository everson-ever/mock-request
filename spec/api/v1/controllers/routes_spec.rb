...
RSpec.describe "Routes", type: :request do
  ...
  describe "GET /routes/:client/:endpoint" do
  ...
  describe "POST /routes/:client/:endpoint" do
    before { endpoint.request_method = "POST" }
    ...
    describe "when client dont exists" do
      before do
        post "/api/v1/routes/#{invalid_client_url}/#{invalid_endpoint}"
      end
    ...
    describe "when client exists and endpoint dont exists" do
      before do
        client.save
        post "/api/v1/routes/#{client.url}/#{invalid_endpoint}"
      end
